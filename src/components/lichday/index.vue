    ...
    export default {
        ...
        methods: {
            searchLichDay() {
                ...
                Axios.get(_this.url + '/api/get-lich?' + 'hk_id=' + data.hk_id.id + '&phong_may_id=' + data.hk_id.id + '&tuan_id=' + data.tuan_id.id).then((response) => {
            ...
            checkLichtruc(ca_id, thu_id) {
                ...
                for(var item of _this.dataLich.lichDay) {
                    console.log(item.ca_id);
                    console.log(item.thu_id);
                ...
                //     if(item.ca_id == ca_id && item.thu_id == thu_id && item.tentuan == _this.selectedTuanhoc.tuanthu && item.phongmay_id == _this.selectedPhongmay)
                //         demnghi++;
                //     if(demnghi == 1) {
                ...
                //             if(item.ca_id == ca_id && item.thu_id == thu_id && tuanhoc[_this.selectedTuanhoc.tuanthu] == "x")
                //                 dem++;
                //             if(dem == 1) {
                //                 result = item;
                //                 break;
